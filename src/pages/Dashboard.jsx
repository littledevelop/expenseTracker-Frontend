...
const Dashboard = () => {
  ...
  const totalIncome =
    incomeData && Array.isArray(incomeData)
      ? incomeData.reduce(
          (sum, item) => sum + parseFloat(item.amount || item),
          0
        )
      : 0;
  const totalExpense =
    ...
    <div className="p-2 space-y-4">
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-6">
          Welcome to your personal expense tracker! Manage your finances with
          ease.
        </p>
      </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-red-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl md:text-3xl text-center text-red-600 font-bold mt-2">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-blue-500 md:col-span-1">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                className={`text-2xl md:text-3xl text-center font-bold mt-2 truncate max-w-full ${
